...
<h5>Background: Reproduction of commissioned public health data science research. Methodology: Generalized Additive Models to fit nonlinear relationships in data</h5>
